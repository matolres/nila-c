...
Next, armed with homemade masking tools and a touch of artistry,</p><p>
...
After that, he irons it twice, adds a protective layer of varnish, and waterproofs the paint to keep the colors vibrant after many washes.
                    ...
                    <Image className={styles.casper_image} alt=''
                    src="/about.jpg"
                    layout='responsive' objectfit='cover' height={300} width={300}
                    />
                </div>  
            </section>
            <Footer 
